...
<head>
    ...
    <link href="/static/css/h-admin/H-ui.login.css" rel="stylesheet" type="text/css" />
    <link href="/static/css/h-admin/style.css" rel="stylesheet" type="text/css" />
    <link href="/static/js/lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
    <![endif]-->
        ...
        <form class="form form-horizontal" id="loginForm" action=" ">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    ...
                    <img src="/verify" id="verify"> <a id="kanbuq"  href="javascript:;">看不清，换一张</a> </div>
            </div>
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <label for="online">
