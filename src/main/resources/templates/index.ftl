...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/css/skin/green/skin.css" id="skin" />
                ...
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        ...
                        <#if Session.SESSION_USER_INFO?exists>
                              ${Session.SESSION_USER_INFO.name}
                        </#if>   <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" id="info">个人信息</a></li>
                            <li><a href="/admin/cat_user">切换账户</a></li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="/admin/system/user/list" data-title="资讯管理" href="javascript:void(0)">用户列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
...
<script type="text/javascript" src="/static/js/lib/h-admin/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
